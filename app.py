...
st.set_page_config(
    page_title="TumorNet - Brain Tumor AI Analysis",
...
st.markdown(
    ...
    <div class="logo-header">
        ...
        ">
            <div class="logo-title">TumorNet</div>
        ...
        try:
            ...
            with open(pdf_path, "rb") as f:
                st.download_button(
                    ...
                    data=f,
                    file_name="TumorNet_Medical_Report.pdf",
...
st.markdown(
    ...
    ">
        <div style="font-size: 1.3rem; font-weight: 700; color: #a5b4fc; margin-bottom: 1rem;">
            🧬 About TumorNet AI Platform
        </div>
        <div style="font-size: 1rem; line-height: 1.7; color: #d1d5db; max-width: 800px; margin: 0 auto;">
            TumorNet leverages state-of-the-art deep learning models for accurate brain tumor detection and segmentation.
